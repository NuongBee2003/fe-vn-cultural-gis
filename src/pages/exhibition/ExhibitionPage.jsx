      ...
      <div className="h-full overflow-y-auto px-6 py-8">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-xs text-stone-400 mb-4">
            ...
            {activeTab === "explore" && activeFilter !== "all"
              ? ` · Danh mục: ${EXHIBITION_FILTERS.find((f) => f.key === activeFilter)?.label}`
              : ""}
            {activeTab === "explore" && selectedProvince !== "all"
              ? ` · Tỉnh/TP: ${selectedProvince}`
              : ""}
          </p>
