...
export const CULTURE_FOLK_ART_ITEMS = [
  {
    ...
    summary: "Tranh in từ khắc gỗ, màu tự nhiên, nội dung dân gian và cát tường.",
    image: tranhDongHo,
    folkType: "art",
    category: "painting",
    province: "Bắc Ninh",
  ...
  },
  {
    ...
    detail: {
      ...
      highlights: ["Trống chiêng rộn ràng", "Nhảy trên cột", "Biểu diễn đường phố"],
  ...
  },
  {
    id: "folk-3",
    title: "Chèo",
    summary: "Kịch hát dân gian Bắc Bộ, hài hước, gần gũi đời sống nông thôn.",
    image: tayBac,
    folkType: "art",
    category: "theater",
    province: "Nam Định",
  ...
  },
  {
    id: "folk-6",
    title: "Dệt thổ cẩm",
    summary: "Vải thổ cẩm của các dân tộc Tây Nguyên, Tây Bắc — hoa văn kể chuyện.",
    image: tayBac,
    folkType: "art",
    category: "craft",
    province: "Tây Nguyên",
    ...
    detail: {
      ...
      highlights: ["Khung dệt thủ công", "Hoa văn tượng trưng", "Trang phục lễ hội"],
  ...
  },
  {
    id: "folk-8",
    title: "Chầu văn",
    summary: "Hát văn trong lễ hầu đồng — kết hợp âm nhạc, múa, trang phục.",
    image: coPhuc,
    folkType: "art",
    category: "ritual",
    province: "Nam Định",
  ...
  },
  {
    ...
    summary: "Làng nghề in tranh trên sông Cầu, nghề truyền từ đời này sang đời khác.",
    image: tranhDongHo,
    folkType: "village",
    category: "painting",
    province: "Bắc Ninh",
    ...
    detail: {
      ...
      highlights: ["Hộ nghệ nhân", "Chợ tranh Tết", "Bảo tàng làng nghề"],
      studioStyle: "Tranh Đông Hồ",
  ...
  },
  {
    ...
    detail: {
      ...
      highlights: ["Tour làng nghề", "Nặn gốm trải nghiệm", "Chợ gốm"],
      province: "Gia Lâm, Hà Nội",
    },
  },
  {
    ...
    summary: "Làng dệt thổ cẩm Ba Na ở Gia Lai — khăn piêu và váy thổ cẩm.",
    image: tayBac,
    folkType: "village",
    category: "craft",
    province: "Gia Lai",
    ...
    detail: {
      ...
      highlights: ["Khung dệt truyền thống", "Nhuộm thực vật", "Chợ phiên"],
      province: "Gia Lai",
    },
  },
];
