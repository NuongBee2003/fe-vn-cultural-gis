// History Images
import ImgAuLac from "@/assets/img/history/aulac.jpg";
import ImgAuLacSupDo from "@/assets/img/history/aulacsupdo.jpg";
import ImgConRongChauTien from "@/assets/img/history/conrongchautien.jpeg";
import ImgDongSon from "@/assets/img/history/dongson.jpg";
import KiDoDa from "@/assets/img/history/kidoda.webp";
import ThoiKyDoDong from "@/assets/img/history/kidodong.jpg";
...
import KinhDuongVuong from "@/assets/img/history-character/kinh-duong-vuong.jpg";
import LacLongQuan from "@/assets/img/history-character/laclongquan-auco.jpg";
...
export const HISTORY_TIMELINE = [
  ...
  {
    id: 1,
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Thời Tiền Sử – Hồng Bàng",
    period: "Khoảng 2879 TCN – 258 TCN",
    description: "Giai đoạn khởi đầu của dân tộc Việt, gắn liền với truyền thuyết Lạc Long Quân và Âu Cơ – tổ tiên của người Việt. Đây là thời kỳ hình thành bản sắc văn hóa, tín ngưỡng và cấu trúc xã hội đầu tiên của người Việt cổ.",
    figure: "Lạc Long Quân – Âu Cơ",
    image: TienSu,
    figureDescription: "Cuộc hôn phối giữa Lạc Long Quân và Âu Cơ sinh ra bọc trăm trứng, nở thành 100 người con, biểu tượng cho sự thống nhất nguồn gốc của dân tộc Việt. Việc chia 50 con theo cha xuống biển, 50 con theo mẹ lên núi thể hiện sự hình thành cộng đồng người Việt trên khắp vùng đồng bằng, trung du và miền núi, đồng thời phản ánh đặc điểm địa lý và lối sống đa dạng của cư dân Việt cổ Hình tượng Lạc Long Quân không chỉ mang ý nghĩa truyền thuyết mà còn khẳng định ý thức cội nguồn, tinh thần đoàn kết dân tộc và khát vọng dựng nước từ thời sơ khai, trở thành nền tảng tinh thần cho lịch sử Việt Nam sau này",
    figureImage: LacLongQuan,
  },
  {
    id: 2,
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Thời Kỳ Đồ Đá",
    period: "Khoảng 40.000 – 3.000 TCN",
    description: "Con người bắt đầu định cư trên lãnh thổ Việt Nam, sử dụng công cụ bằng đá thô sơ để săn bắt và hái lượm. Các di chỉ khảo cổ như Hòa Bình, Bắc Sơn cho thấy nền văn hóa đồ đá phong phú.",
    figure: "Kinh Dương Vương",
    image: KiDoDa,
    figureDescription: "Kinh Dương Vương được xem là vị thủy tổ trong truyền thuyết dựng nước của người Việt. Ông tượng trưng cho giai đoạn hình thành sớm nhất của cộng đồng cư dân Việt cổ, khi con người sống chủ yếu bằng săn bắt, hái lượm và bắt đầu biết chế tác công cụ đá. Dù mang tính huyền thoại, hình tượng Kinh Dương Vương phản ánh nhận thức của người Việt về cội nguồn dân tộc, đánh dấu bước khởi đầu của quá trình hình thành xã hội nguyên thủy trên đất Việt",
    figureImage: KinhDuongVuong,
  },
  {
    id: 3,
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Thời Kỳ Đồ Đồng – Đồ Sắt",
    period: "Khoảng 3.000 TCN – 1.000 TCN",
    description: "Người Việt cổ chuyển từ đồ đá sang đồ đồng rồi đồ sắt, phát triển nông nghiệp lúa nước, đúc trống đồng. Đây là bước ngoặt lớn trong sản xuất và tổ chức xã hội.",
    figure: "Hùng Quốc Vương",
    image: ThoiKyDoDong,
    figureDescription: "Hùng Quốc Vương là danh xưng chung cho các thủ lĩnh bộ lạc trong giai đoạn chuyển tiếp từ xã hội nguyên thủy sang xã hội có tổ chức cao hơn. Thời kì này, cư dân Việt cổ đã biết luyện kim, chế tác công cụ bằng đồng và sắt, phát triển nông nghiệp trồng lúa nước. Sự xuất hiện của các thủ lĩnh đứng đầu cộng đồng phản ánh bước tiến quan trọng trong tổ chức xã hội, đặt nền móng cho nhà nước sơ khai sau này",
    figureImage: HungQuocVuong,
  },
  {
    id: 4,
    era: "Thời Tiền Sử & Hồng Bàng",
    ...
    period: "700 TCN – 100 SCN",
    description: "Nền văn minh rực rỡ của người Việt cổ, nổi tiếng với trống đồng Đông Sơn – biểu tượng văn hóa Đông Nam Á. Xã hội có tổ chức chặt chẽ, phát triển thủ công nghiệp và giao thương.",
    figure: "Các Vua Hùng",
    image: ImgDongSon,
    figureDescription: "Vua Hùng là biểu tượng tiêu biểu nhất của văn hóa Đông Sơn và thời đại dựng nước Văn Lang. Dưới thời các Vua Hùng, cư dân Đông Sơn đạt trình độ phát triển cao về kỹ thuật luyện đồng, tiêu biểu là trống đồng Đông Sơn – biểu tượng quyền lực, tín ngưỡng và đời sống tinh thần. Xã hội có tổ chức chặt chẽ hơn, kinh tế nông nghiệp lúa nước phát triển, đời sống văn hóa phong phú. Thời đại Hùng Vương đánh dấu bước hình thành rõ nét của quốc gia sơ khai đầu tiên trong lịch sử Việt Nam.",
    figureImage: CharVuaHungVuong,
  },
  {
    id: 5,
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Thời Đại Các Vua Hùng",
    period: "2879 TCN – 258 TCN",
    description: "18 đời Vua Hùng trị vì nước Văn Lang, đặt nền móng cho nhà nước sơ khai đầu tiên của người Việt. Đây là thời kỳ hình thành phong tục tập quán, lễ hội và tinh thần đoàn kết dân tộc.",
    figure: "Hùng Vương",
    image: ImgThoiDaiVuaHung,
    figureDescription: "Người con trưởng của Lạc Long Quân và Âu Cơ được tôn làm Hùng Vương, lập nên nhà nước Văn Lang và đóng đô tại Phong Châu. Các vua Hùng nối tiếp nhau cai trị đất nước cho đến năm 258 TCN.",
    figureImage: CharVuaHungVuong,
  },
  {
    id: 6,
    ...
    period: "Thời huyền sử",
    description: "Lạc Long Quân (thuộc dòng Rồng) và Âu Cơ (thuộc dòng Tiên) kết duyên, sinh ra bọc trăm trứng nở thành trăm người con. Đây là nguồn gốc huyền thoại của dân tộc Việt Nam.",
    figure: "Lạc Long Quân Và Âu Cơ",
    image: ImgConRongChauTien,
    figureDescription: "",
    figureImage: LacLongQuan
  },
  {
    ...
    period: "2879 TCN – 258 TCN",
    description: "Nhà nước đầu tiên trong lịch sử Việt Nam, do các Vua Hùng lãnh đạo. Lãnh thổ chủ yếu ở vùng đồng bằng Bắc Bộ và Bắc Trung Bộ ngày nay, tổ chức theo mô hình 15 bộ lạc.",
    figure: "Thục Phán An Dương Vương",
    image: ImgVanLang,
    figureDescription: "Ông là người lãnh đạo tối cao của Âu Lạc trong cuộc kháng chiến chống quân Tần năm 218 TCN. An Dương Vương đã thống nhất Âu Việt và Lạc Việt, xây dựng nhà nước Âu Lạc, tổ chức phòng thủ chặt chẽ và trực tiếp chỉ đạo kháng chiến. Dưới sự lãnh đạo của ông, quân Tần gặp nhiều khó khăn, không thể nhanh chóng thôn tính Âu Lạc",
    figureImage: CharAnDuongVuong
  },
  {
    id: 8,
    era: "Thời Tiền Sử & Hồng Bàng",
    ...
    period: "Thời Hùng Vương thứ 6",
    description: "Thánh Gióng – cậu bé làng Phù Đổng lớn nhanh như thổi, cưỡi ngựa sắt đánh đuổi giặc Ân rồi bay về trời. Truyền thuyết ca ngợi tinh thần yêu nước và sức mạnh bảo vệ tổ quốc của người Việt.",
    figure: "Thánh Gióng",
    image: ImgTruyenThuyetThanhGiong,
    figureDescription: "Thánh Gióng là hình tượng tiêu biểu cho người anh hùng chống ngoại xâm thời Hùng Vương. Nhân vật đại diện cho sức mạnh, tinh thần đoàn kết và ý chí bảo vệ đất nước của dân tộc Việt cổ. Truyền thuyết Thánh Gióng phản ánh khát vọng đánh giặc, giữ nước và niềm tin rằng khi Tổ quốc lâm nguy, nhân dân sẽ xuất hiện những con người phi thường đứng lên cứu nước",
    figureImage: CharThanhGiong
  },
  {
    id: 9,
    era: "Thời Tiền Sử & Hồng Bàng",
    ...
    description: "Thục Phán An Dương Vương thống nhất hai bộ tộc Âu Việt và Lạc Việt, lập nước Âu Lạc. Ông xây thành Cổ Loa hình xoắn ốc kiên cố, chế tạo nỏ thần để bảo vệ đất nước.",
    figure: "An Dương Vương",
    image: ImgAuLac,
    figureDescription: "An Dương Vương là người sáng lập và trị vì nước Âu Lạc. Ông thống nhất các bộ lạc Âu Việt và Lạc Việt, xây dựng nhà nước Âu Lạc độc lập. Dưới thời ông, thành Cổ Loa được xây dựng như một trung tâm chính trị, quân sự lớn, thể hiện trình độ tổ chức và phòng thủ cao. Vì vậy, An Dương Vương là danh nhân tiêu biểu nhất của nước Âu Lạc trong giai đoạn này",
    figureImage: CharAnDuongVuong
  },
  {
    id: 10,
    ...
    period: "257 TCN – Khoảng 179 TCN",
    description: "Thành Cổ Loa là kinh đô của nước Âu Lạc, được xây dựng theo hình trôn ốc độc đáo. Đây là tòa thành cổ nhất Đông Nam Á, biểu tượng cho tài năng kiến trúc và quân sự của người Việt.",
    figure: "An Dương Vương",
    image: ImgThanhCoLoa,
    figureDescription: "An Dương Vương là người sáng lập và trị vì nước Âu Lạc. Ông thống nhất các bộ lạc Âu Việt và Lạc Việt, xây dựng nhà nước Âu Lạc độc lập. Dưới thời ông, thành Cổ Loa được xây dựng như một trung tâm chính trị, quân sự lớn, thể hiện trình độ tổ chức và phòng thủ cao. Vì vậy, An Dương Vương là danh nhân tiêu biểu nhất của nước Âu Lạc trong giai đoạn này",
    figureImage: CharAnDuongVuong
  },
  {
    ...
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Cuộc Xâm Lược Của Nhà Tần",
    period: "218 TCN",
    description: "Tần Thủy Hoàng sai quân Nam chinh xuống phương Nam, vấp phải sự kháng cự quyết liệt của người Việt trong nhiều năm. Đây là một trong những lần đầu tiên người Việt chống lại sự xâm lăng của phương Bắc.",
    figure: "Tần Thủy Hoàng",
    image: ImgNhaTanXamLuoc,
    figureDescription: "Tần Thủy Hoàng là hoàng đế đầu tiên của Trung Quốc, người thực hiện chính sách bành trướng lãnh thổ về phía Nam. Năm 218 TCN, ông sai quân tiến đánh vùng đất Bách Việt, trong đó có Âu Lạc, nhằm mở rộng quyền kiểm soát. Cuộc xâm lược này gặp sự kháng cự quyết liệt của cư dân bản địa và gặp nhiều khó khăn do địa hình hiểm trở, khí hậu khắc nghiệt. Dù quân Tần có ưu thế về số lượng, chiến dịch này không đạt được thắng lợi nhanh chóng như mong muốn",
    figureImage: CharTanThuyHoang
  },
  {
    id: 12,
    era: "Thời Tiền Sử & Hồng Bàng",
    eraColor: "#6C4AB6",
    title: "Nước Âu Lạc Sụp Đổ",
    period: "179 TCN",
    description: "Triệu Đà dùng mưu kế thông qua con trai là Trọng Thủy lấy Mỵ Châu – con gái An Dương Vương, đánh cắp bí mật nỏ thần, chiếm Âu Lạc. Nước ta bắt đầu thời kỳ Bắc thuộc dài hơn 1000 năm.",
    figure: "Triệu Đà",
    image: ImgAuLacSupDo,
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Nhà Triệu & Sự Sáp Nhập Âu Lạc",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Nam Việt Diệt Vong – Nhà Hán Đô Hộ",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Sự Hình Thành Nước Champa",
    period: "192 SCN",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Khởi Nghĩa Lý Bí – Nhà Nước Vạn Xuân",
    period: "542 – 602",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Khúc Thừa Dụ – Bước Mở Đầu Tự Chủ",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Dương Đình Nghệ Giữ Vững Độc Lập",
  ...
  },
  {
    ...
    era: "Thời Bắc Thuộc",
    eraColor: "#185FA5",
    title: "Ngô Quyền Đại Thắng Bạch Đằng",
    period: "938 SCN",
  ...
  {
    id: 25,
    era: "Tự Chủ & Phong Kiến Sớm",
    eraColor: "#0F6E56",
    title: "Ngô Quyền Lập Nhà Ngô",
  ...
  },
  {
    ...
    era: "Tự Chủ & Phong Kiến Sớm",
    eraColor: "#0F6E56",
    title: "Lê Hoàn Lập Nhà Tiền Lê – Đại Phá Quân Tống",
  ...
  },
  {
    ...
    era: "Tự Chủ & Phong Kiến Sớm",
    eraColor: "#0F6E56",
    title: "Đánh Chiêm Thành – Mở Rộng Về Phương Nam",
    period: "982 SCN",
  ...
  },
  {
    ...
    era: "Tự Chủ & Phong Kiến Sớm",
    eraColor: "#0F6E56",
    title: "Khủng Hoảng Kế Vị Triều Tiền Lê",
    period: "1005 – 1009",
  ...
  {
    id: 33,
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Lý Công Uẩn Lên Ngôi Vua",
    period: "1009",
  ...
  },
  {
    ...
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Đổi Tên Nước Thành Đại Việt",
    period: "1054",
  ...
  },
  {
    ...
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Chợ Kẻ Chợ – Trung Tâm Thăng Long",
  ...
  },
  {
    ...
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Khoa Thi Đầu Tiên Trong Lịch Sử",
    period: "1075",
  ...
  },
  {
    ...
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Sự Hình Thành Thương Cảng Vân Đồn",
    period: "1149",
  ...
  },
  {
    ...
    era: "Nhà Lý (1009–1225)",
    eraColor: "#3B6D11",
    title: "Lý Chiêu Hoàng Nhường Ngôi",
    period: "1225",
  ...
  },
  {
    ...
    era: "Nhà Trần (1225–1400)",
    eraColor: "#639922",
    title: "Kháng Chiến Chống Nguyên Mông Lần 3",
    period: "1287 – 1288",
  ...
  {
    id: 49,
    era: "Nhà Hồ & Minh Thuộc",
    eraColor: "#BA7517",
    title: "Nhà Hồ & Minh Thuộc",
    period: "1400 – 1427",
  ...
  },
  {
    ...
    era: "Nhà Hồ & Minh Thuộc",
    eraColor: "#BA7517",
    title: "Nhà Minh Xâm Lược Đại Ngu",
    period: "1407",
  ...
  },
  {
    ...
    era: "Nhà Hậu Lê (1428–1789)",
    eraColor: "#854F0B",
    title: "Lê Lợi Lên Ngôi – Triều Hậu Lê",
    period: "1428",
  ...
  },
  {
    ...
    era: "Nhà Hậu Lê (1428–1789)",
    eraColor: "#854F0B",
    title: "Vua Lê Thánh Tông Qua Đời",
    period: "1497",
  ...
  },
  {
    ...
    era: "Nhà Hậu Lê (1428–1789)",
    eraColor: "#854F0B",
    title: "Thời Kỳ Lê-Mạc Phân Tranh",
    period: "1527 – 1592",
  ...
  },
  {
    ...
    era: "Nhà Mạc (1527–1677)",
    eraColor: "#854F0B",
    title: "Mạc Đăng Dung Lập Triều Mạc",
    period: "1527",
  ...
  },
  {
    ...
    era: "Nhà Mạc (1527–1677)",
    eraColor: "#854F0B",
    title: "Mạc Đăng Dung Quy Phục Nhà Minh",
    period: "1540",
  ...
  },
  {
    ...
    era: "Nhà Mạc (1527–1677)",
    eraColor: "#854F0B",
    title: "Mất Thăng Long – Nhà Mạc Chạy Về Cao Bằng",
    period: "1592",
  ...
  },
  {
    ...
    era: "Nhà Mạc (1527–1677)",
    eraColor: "#854F0B",
    title: "Nhà Mạc Bị Tiêu Diệt Ở Cao Bằng",
    period: "1677",
  ...
  },
  {
    ...
    era: "Nhà Hậu Lê (1428–1789)",
    eraColor: "#854F0B",
    title: "Lãnh Thổ Đại Việt Hình Chữ S",
    period: "1711",
  ...
  },
  {
    ...
    era: "Triều Tây Sơn (1778–1802)",
    eraColor: "#993C1D",
    title: "Tây Sơn Tiêu Diệt Chúa Nguyễn Ở Đàng Trong",
    period: "1777",
  ...
  },
  {
    ...
    era: "Triều Tây Sơn (1778–1802)",
    eraColor: "#993C1D",
    title: "Nguyễn Huệ Tiến Ra Bắc Diệt Trịnh",
    period: "1786",
  ...
  },
  {
    ...
    era: "Triều Tây Sơn (1778–1802)",
    eraColor: "#993C1D",
    title: "Đại Phá Quân Thanh – Tết Kỷ Dậu",
    period: "1789",
  ...
  },
  {
    ...
    era: "Triều Tây Sơn (1778–1802)",
    eraColor: "#993C1D",
    title: "Vua Quang Trung Băng Hà – Tây Sơn Suy Yếu",
    period: "1792",
  ...
  },
  {
    ...
    era: "Nhà Nguyễn (1802–1945)",
    eraColor: "#A32D2D",
    title: "Vua Gia Long Đổi Quốc Hiệu Thành Việt Nam",
    period: "1804",
  ...
  },
  {
    ...
    era: "Nhà Nguyễn (1802–1945)",
    eraColor: "#A32D2D",
    title: "Vua Minh Mạng Đổi Quốc Hiệu Thành Đại Nam",
    period: "1839",
  ...
  },
  {
    ...
    era: "Nhà Nguyễn (1802–1945)",
    eraColor: "#A32D2D",
    title: "Nguyễn Trường Tộ Và Tư Tưởng Cải Cách",
  ...
  },
  {
    ...
    era: "Nhà Nguyễn (1802–1945)",
    eraColor: "#A32D2D",
    title: "Thực Dân Pháp Nổ Súng Xâm Lược",
    period: "01-9-1858",
  ...
  // ─── PHÁP THUỘC & KHÁNG CHIẾN ──────────────────────────────────────────────
  {
    id: 79,
    era: "Pháp Thuộc & Kháng Chiến",
    eraColor: "#533434",
  ...
  },
  {
    ...
    era: "Pháp Thuộc & Kháng Chiến",
    eraColor: "#533434",
    title: "Cách Mạng Tháng 8 Thành Công",
  ...
  },
  {
    ...
    era: "Pháp Thuộc & Kháng Chiến",
    eraColor: "#533434",
    title: "Quan Hệ Việt Minh – Mỹ Trong Thế Chiến 2",
    period: "1945",
  ...
  {
    id: 92,
    era: "Kháng Chiến Chống Mỹ (1954–1975)",
    eraColor: "#5F5E5A",
  ...
  },
  {
    ...
    era: "Kháng Chiến Chống Mỹ (1954–1975)",
    eraColor: "#5F5E5A",
    title: "Đánh Bại Cuộc Hành Quân Junction City",
  ...
  },
  {
    ...
    era: "Kháng Chiến Chống Mỹ (1954–1975)",
    eraColor: "#5F5E5A",
    title: "Chiến Dịch Đường 9 – Khe Sanh",
    period: "21-1 – 7-1968",
  ...
  },
  {
    ...
    era: "Kháng Chiến Chống Mỹ (1954–1975)",
    eraColor: "#5F5E5A",
    title: "Các Chiến Dịch Tiêu Biểu Năm 1975",
    period: "1975",
  ...
  {
    id: 99,
    era: "Việt Nam Hiện Đại (1975–nay)",
    eraColor: "#0F6E56",
    title: "Thống Nhất Đất Nước – Việt Nam Hiện Đại",
    period: "1975 – nay",
  ...
  },
  {
    ...
    era: "Việt Nam Hiện Đại (1975–nay)",
    eraColor: "#0F6E56",
    title: "Thành Lập Nước Cộng Hòa XHCN Việt Nam",
    period: "2-7-1976",
  ...
  },
  {
    ...
    era: "Việt Nam Hiện Đại (1975–nay)",
    eraColor: "#0F6E56",
    title: "Đường Lối Đổi Mới Toàn Diện – Đại Hội VI",
    period: "1986",
  ...
  },
  {
    ...
    era: "Việt Nam Hiện Đại (1975–nay)",
    eraColor: "#0F6E56",
    title: "Việt Nam Gia Nhập ASEAN & Bình Thường Hóa Quan Hệ Với Mỹ",
    period: "Tháng 7-1995",
